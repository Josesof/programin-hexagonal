package com.company.game.infraestructure.repositories;

import com.company.game.domain.model.Task;
import com.company.game.domain.ports.output.TaskRepositoryPort;
import com.company.game.infraestructure.entities.TaskEntity;
...
public class JpaTaskRepositoryAdapter implements TaskRepositoryPort {
  ...
  public List<Task> findAll() {
    return jpaTaskRepository.findAll().stream()
           .map(TaskEntity::toDomainModel).collect(Collectors.toList());
  }
